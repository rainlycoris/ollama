...
func AsMap() map[string]EnvVar {
	ret := map[string]EnvVar{
		...
		"OLLAMA_KV_CACHE_TYPE":     {"OLLAMA_KV_CACHE_TYPE", KvCacheType(), "Quantization type for the K/V cache (default: f16). Options: f16, q8_0, q4_0. This can be a single type (e.g., f16) which applies to both K and V, or a colon-separated pair for differentiated quantization (e.g., q8_0:q4_0 for K:V)."},
