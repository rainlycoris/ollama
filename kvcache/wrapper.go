...
func (c *WrapperCache) Init(backend ml.Backend, typeK, typeV ml.DType, maxSequences, capacity, maxBatch int) {
	for _, cache := range c.caches {
		cache.Init(backend, typeK, typeV, maxSequences, capacity, maxBatch)
	}
}
